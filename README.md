...
Access to a partial version of the raw and preprocessed integrated dataset "DiaData: A Multi-Modal, Integrated Time-Series Dataset for Type 1 Diabetes Research", containing 13 out of the 15 datasets is provided in [https://doi.org/10.5281/zenodo.16874128](https://doi.org/10.5281/zenodo.16874128), doi: 10.5281/zenodo.16874128.
